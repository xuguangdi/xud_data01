...
DATASET_ROOT = "data_flowers/data_flowers5"
...
# Visual backbone helper
def build_torchvision_backbone(name, device):
    """
    Return (backbone_model, feature_dim, preprocess_transform)
    backbone forward should output feature vector (B, feat_dim) when classifier/head removed.
    """
...
def train_one_model(model_name, device, tokenizer=None, clip_model=None, preprocess_for_clip=None):
    ...
    val_ds = StrawberryDataset(DATASET_ROOT, 'val', transform=val_transform)
